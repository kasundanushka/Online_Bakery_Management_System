...
<div class="intro-text">
    <h1>Our Menu</h1>
    <p>Discover our complete selection of freshly baked goods, from traditional breads to decadent desserts.</p>
</div>

<div class="product-list">
<?php
$SQL = "SELECT * FROM bakeryitems";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                    ...
                    <span class="product-title">'.htmlspecialchars($row['Name']).'</span><br>
                    <p style="color:
#3d4c2a;">'.htmlspecialchars($row['description']).'</p>
                <div class="product-header">
                    <span class="product-price">LKR '.htmlspecialchars($row['Price']).'</span>
                </div>
    ...
    echo "<p>No bakery items found.</p>";
}
$conn->close();
?>
</div>
